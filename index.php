...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbarText">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="#abroad">Study Abroad</a>
					</li>
	...
	<div id="stage">
		<div id="stage-caption">
			<h1 class="display-3">An award-winning consultant for international students takes good care of you</h1>
	...
	<section id="about">
		...
		<section id="ceo">
		<div class="container">
			<h1 class="message">Message from CEO</h1>
			<div class="row">
	...
	<section id="abroad">
		<div class="container">
			<div class="row">
				<div class="col-lg-5"><img src="img/group.jpg" alt="CEO" /></div>
			...
			<div class="row edu_sys">
					<div class="col-lg-5">
					<h2>American Education System</h2>
					<p class="lead">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>

				</div>
				<div class="col-lg-6 offset-lg-1"><img src="img/sys.jpg" alt="Education System" /></div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="row">
						<div class="col-lg-12">
							<h2>Address</h2>
							<p>350 W 114 Avenue, Suit 1608</p>
							<p>Northglenn, Colorado 80234</p>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-1">
	...
	<footer class="main-footer">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6">
					Copyright @ 2019 Apline Info LLC. All right reserved
				</div>
				<div class="col-md-2 offset-lg-4 justify-content-end">
					Designed by <a href="http://aplineinfo.com" target="_blank">Apline Info</a>
				</div>
			</div>
		</div>
	</footer>
